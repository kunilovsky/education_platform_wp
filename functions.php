...
{
	wp_enqueue_style('education-style-bs', get_template_directory_uri() . '/assets/style/bs.css');
	wp_enqueue_style('education-style', get_template_directory_uri() . '/assets/style/style.css');
	wp_enqueue_script('education-bs-js', get_template_directory_uri() . '/assets/js/bs.js');
